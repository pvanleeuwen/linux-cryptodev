...
static const struct alg_test_desc alg_test_descs[] = {
	{
		...
		.fuzz_params = {
			.aead = {
				.ckeylensel = __LENS(aes_klen_template),
				.akeylensel = __LENS(hmac_sha224_klen_template),
				.authsizesel = __LENS(sha224_authsize_template),
				.aadlensel = __LENS(aead_alen_template),
				.ptxtlensel = __LENS(aead_plen_template),
			}
		}
		...
		.fuzz_params = {
			.aead = {
				.ckeylensel = __LENS(aes_klen_template),
				.akeylensel = __LENS(hmac_sha384_klen_template),
				.authsizesel = __LENS(sha384_authsize_template),
				.aadlensel = __LENS(aead_alen_template),
				.ptxtlensel = __LENS(aead_plen_template),
			}
		}
